"""SEAM akses data untuk resource `WcpJawaban`."""
...
class WcpJawabanService(Protocol):
    """Kontrak operasi terhadap WcpJawaban."""
...
class InMemoryWcpJawabanService:
    ...
    @staticmethod
    def _to_read(rec: _Record) -> WcpJawabanRead:
        return WcpJawabanRead.model_validate(rec)
