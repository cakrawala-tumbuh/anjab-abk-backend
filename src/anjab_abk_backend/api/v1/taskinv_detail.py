    ...
    responses={
        ...
        **_NOT_FOUND_RSP,
        422: {
            "model": ErrorResponse,
            "description": (
                "Sesi bukan TAHAP3, responden sudah submit, belum ada entri detail, ada"
                " entri belum lengkap kelima field CalHR-nya, atau masih ada entri"
                ' ber-va_type "Context-Dependent" yang belum difinalisasi.'
            ),
        },
    },
)
