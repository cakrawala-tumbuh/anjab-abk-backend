...
logger = logging.getLogger("anjab_abk_backend.api.v1.dcs_sesi")
...
@router.delete(
    ...
    summary="Hapus sesi DCS (DRAFT bebas; status lain wajib paksa=true)",
...
def delete_sesi(
    ...
    if paksa:
        logger.warning(
            "force_delete_sesi",
            extra={"modul": "dcs", "sesi_id": sesi_id, "actor": principal.subject},
        )
